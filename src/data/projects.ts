...
export const projects: Project[] = [
  ...
  },
  {
    ...
    subtitle: 'AI chatbot with retrieval-augmented generation',
    challenge: 'An organization needed a chatbot that could answer user queries accurately from their official documents — not hallucinate generic responses.',
    approach: 'Built a RAG pipeline using LlamaIndex + Pinecone vector DB. PDFs are uploaded, chunked, and embedded via OpenAI. User queries retrieve relevant chunks and feed them as context to GPT-4. Added Redis-backed chat memory, async message processing, and conversation threading.',
    results: [
