...
export const experience: ExperienceEntry[] = [
  {
    ...
    bullets: [
      ...
      'Led the Flutter rebuild of the GenixDrive app for its 3.0 release, authoring over 80% of the changes: consent-scoped live-location and trip sharing, group drives with live ETAs over Socket.IO and Google Maps, a push-notification router for ~90 event types, 480+ automated tests and a Codemagic-to-TestFlight pipeline, against a NestJS/PostGIS backend on AWS Lightsail.',
    ],
